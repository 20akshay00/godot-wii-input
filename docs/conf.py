...
project = "GDWiiInput"
copyright = "2025-present Akshay Shankar and the GDWiiInput contributors (CC BY 3.0)"
author = "Akshay Shankar and the GDWiiInput contributors"
...
html_context = {
    ...
    "github_repo": "godot-wii-input",  # Repo name
...
latex_documents = [
    (
        ...
        "Akshay Shankar and the GDWiiInput contributors",
        "manual",
    ),
]
